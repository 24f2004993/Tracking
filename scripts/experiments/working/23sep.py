...
# ---------------- CONFIG ----------------
INPUT_DIR = 'path/to/project/predict13'
OUTPUT_DIR = "/Users/tanishq/Desktop/merged_coords_output"
...
def list_images_sorted(folder):
    ...
    # This sort is simple and might not handle numbers correctly, e.g., 1, 10, 2
    # For robust numerical sorting, a different key is needed.
    # However, if filenames are zero-padded (e.g., 001, 002, 010), this is fine.
    return sorted(files)
...
def run():
    ...
    for i, fp in enumerate(frames):
        ...
        out_path = os.path.join(OUTPUT_DIR, f"coords_{i:04d}.jpg")
